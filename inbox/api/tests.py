...
class NotificationApiTests(TestCase):
    ...
    def test_unread_count(self):
        ...
        # user1 likes user1's tweet, no notification
        self.user1_client.post(LIKE_URL, {
            'content_type': 'tweet',
        ...
        # user2 likes user1's tweet, 1 notification
        ...
        # user1 likes user1's comment, no notification
        self.user1_client.post(LIKE_URL, {
        ...
        # user2 likes user1's comment, +1 notification
        self.user2_client.post(LIKE_URL, {
            'content_type': 'comment',
            'object_id': comment.id,
        })
